...
NETWORK_HANDLER   = get.Memory(Global_(2462286+5))
VEH_HANDLER       = get.Memory(Global_(2462286+2))
--SPAWNER_CORD_X    = get.Memory("CarSpawn+1190")
--SPAWNER_CORD_Y    = get.Memory("CarSpawn+1198")
--SPAWNER_CORD_Z    = get.Memory("CarSpawn+11A0")
SPAWNER_SPOILER   = get.Memory(Global_(2462286+27+10))
BYPASS_VEH_1      = get.Memory(Global_(2462286+27+95))
BYPASS_VEH_2      = get.Memory(Global_(2462286+27+94))
VEH_LIST          = get.Memory(Global_(2462286+27+66))
AS_PEGASUS        = get.Memory(Global_(2462286+3))
SPW_LIVERY        = get.Memory(Global_(2462286+27+58))

SPAWNER_CORD_X    = get.Memory(Global_(2462286+7+0))
SPAWNER_CORD_Y    = get.Memory(Global_(2462286+7+1))
SPAWNER_CORD_Z    = get.Memory(Global_(2462286+7+2))
...
PLATE_LISENCE     = get.Memory(Global_(2462286+27+1))
TAKE_VISUAL       = get.Memory(Global_(1377909+4714))
CASH              = get.Memory(Global_(262145+28087))
ARTWORK           = get.Memory(Global_(262145+28088))
GOLD              = get.Memory(Global_(262145+28089))
DIAMOND           = get.Memory(Global_(262145+28090))
LESTER_CUT        = get.Memory(Global_(262145+28073))
SALJU             = get.Memory(Global_(262145+4724))
JOIN_STATUS       = get.Memory(Global_(2425869+PLAYER_ID()*443+1))
...
IS_SESSION_PUBLIC = get.Memory(Global_(2451787+742))
TIMER_CARGO       = get.Memory(Global_(262145+15116))
CURRENT_SESSION   = get.Memory(Global_(1312855))
CASINO_CUT_1      = get.Memory(Global_(1697303+2326))
CASINO_CUT_2      = get.Memory(Global_(1697303+2327))
CASINO_CUT_3      = get.Memory(Global_(1697303+2328))
CASINO_CUT_4      = get.Memory(Global_(1697303+2329))
DOOMSDAY_CUT_1    = get.Memory(Global_(1693565+812+50+1))
DOOMSDAY_CUT_2    = get.Memory(Global_(1693565+812+50+2))
DOOMSDAY_CUT_3    = get.Memory(Global_(1693565+812+50+3))
DOOMSDAY_CUT_4    = get.Memory(Global_(1693565+812+50+4))
APT_CUT_1         = get.Memory(Global_(1666210+3008+1))
APT_CUT_2         = get.Memory(Global_(1666210+3008+2))
APT_CUT_3         = get.Memory(Global_(1666210+3008+3))
APT_CUT_4         = get.Memory(Global_(1666210+3008+4))
CPERICO_1         = get.Memory(Global_(1704127+823+56+1))
CPERICO_2         = get.Memory(Global_(1704127+823+56+2))
CPERICO_3         = get.Memory(Global_(1704127+823+56+3))
CPERICO_4         = get.Memory(Global_(1704127+823+56+4))
CAYO_PERICO_BAG   = get.Memory(Global_(262145+28999))
...
Panther  		  =	get.Memory(Global_(262145+29238))
Madrazo_Files	  =	get.Memory(Global_(262145+29237))
Pink_DIAMOND      = get.Memory(Global_(262145+29236))
Bearer_Bonds      =	get.Memory(Global_(262145+29235))
Ruby			  =	get.Memory(Global_(262145+29234))
Tequila	    	  = get.Memory(Global_(262145+29233))
--------------------------Address Definition--------------------------------------------------
...
DMG_TO_HP    = get.Memory(CPlayerInfo + 0xCF0)
DMG_TO_ARMOR = get.Memory(CPlayerInfo + 0xCF4)
...
PLAYER_WANTED_LEVEL   = get.Memory(CPlayerInfo + 0x868)
IS_PLAYER_WANTED_LEVEL   = get.Memory(CPlayerInfo + 0x860)
PLAYER_DMG_MULT_MELEE = get.Memory(CPlayerInfo + 0xCEC)
PLAYER_DMG_MULT_WEP   = get.Memory(CPlayerInfo + 0xCF8)
--TAKE_ALL        = get.Memory("[[GlobalPTR-128]+1180]+2A578")
TAKE_ALL        = get.Memory("[[GlobalPTR-128]+1180]+2A610")

TOTAL_PLAYER    = get.Memory("[PlayerCountPTR]+178")
TOTAL_SESSION   = get.Memory("[[[PlayerCountPTR]+11*8]+B0]")
--CUACA           = get.Memory("GTA5.exe+24C7720")
CUACA           = get.Memory("GTA5.exe+24EDC70")
RID             = get.Memory(CPlayerInfo + 0x70)
IP_ONLINE       = get.Memory(CPlayerInfo + 0x44)
IP_LAN          = get.Memory(CPlayerInfo + 0x34)
PORT            = get.Memory(CPlayerInfo + 0x38)
PLAYER_NAME     = get.Memory(CPlayerInfo + 0x84)
PLAYER_NAME     = get.Memory("GTA5.exe+28E9E74")
PLAYER_NAME     = get.Memory("GTA5.exe+28F47AC")
PLAYER_NAME     = get.Memory("GTA5.exe+28F48FC")
PLAYER_NAME     = get.Memory("GTA5.exe+2D2F304")
PLAYER_NAME     = get.Memory("GTA5.exe+2D3229F")
PLAYER_NAME     = get.Memory("GTA5.exe+2D3569F")
PLAYER_NAME     = get.Memory("GTA5.exe+2D35934")
...
STAT_BOOL		= get.Memory("[[[GTA5.exe+02DA43D8]+68]+B0]+218")
PLAYER_COLLISION = get.Memory("[[[[[[[WorldPTR]+8]+30]+10]+20]+70]+0]+2C")
RID_ASLI         = get.Memory("GTA5.exe+2D62A18")
...
elseif STAT_BOOL == nil then
    local bool_backup3 = get.Memory("[[[[GTA5.exe+02DA43D8]+68]+E0]+20]+218")
